    ...
    return (
        <>
            ...
            <section role="customer service" className="px-4 py-20 text-gray-950 md:px-8">
                <h2 className="text-center font-bold text-[1.6rem] md:text-4xl tracking-wide leading-snug md:text-gray-900">The leading road trip service in India</h2>
                <ul className="grid gap-5 md:grid-cols-2 md:gap-8 mt-8 md:mt-12">
                    <li className="flex items-start gap-5">
                        ...
                        <div>
                            <h3 className="font-semibold tracking-wide mb-0.5 md:text-[1.16rem] md:font-semibold leading-snug">Flexible cancellation up to 72h prior to your journey</h3>
                    ...
                    <li className="flex items-start gap-5">
                        ...
                        <div>
                            <h3 className="font-semibold tracking-wide mb-0.5 md:text-[1.16rem] md:font-semibold">One-way trips are available</h3>
                    ...
                    <li className="flex items-start gap-5">
                        ...
                        <div>
                            <h3 className="font-semibold tracking-wide mb-0.5 md:text-[1.16rem] md:font-semibold">RAC Breakdown Cover</h3>
                    ...
                    <li className="flex items-start gap-5">
                        ...
                        <div>
                            <h3 className="font-semibold tracking-wide mb-0.5 md:text-[1.16rem] md:font-semibold">Book now, pay later!</h3>
