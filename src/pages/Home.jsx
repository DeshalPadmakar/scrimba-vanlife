    ...
    return (
        <>
            ...
            <section role="customer service" className="px-4 py-20 text-gray-950 md:px-8">
                <h2 className="text-center font-bold text-[1.6rem] md:text-[2rem] tracking-wide leading-snug md:text-gray-900">The leading road trip service in India</h2>
            ...
            <section className="px-4 md:px-8 pb-20 text-gray-950">
                <div className="rounded-md overflow-hidden shadow-md bg-blue-100 flex flex-col md:flex-row">
                    ...
                    <div className="px-6 md:px-8 py-10">
                        ...
                        <Link to="vans" className="text-white bg-blue-600 font-bold tracking-wide w-full block text-center py-3 rounded-md hover:bg-blue-700 active:bg-blue-600">Find your van</Link>
                    </div>
                </div>
                ...
                <div className="mt-10 md:mt-12 rounded-md overflow-hidden shadow-md bg-blue-100 flex flex-col md:flex-row">
                    ...
                    <div className="px-6 md:px-8 py-10">
                        ...
                        <Link to="." className="text-white bg-blue-600 font-bold tracking-wide w-full block text-center py-3 rounded-md hover:bg-blue-700 active:bg-blue-600">Rent out my campervan</Link>
                    </div>
                </div>
            </section>
        </>
